...
{
    public static class PullRequestPreviewEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE PullRequestPreviewModuleExtensionConfigurator CLASS (in the Domain.Shared project)
